...
(function($){ 	
	...
	*/
	...
	/**
	* This function updates all columns width according to its real width. It must be taken into user that the
    ...
    $.fn.extend({  
        colResizable: function(options) {           
            var defaults = {
				...
				gripInnerHtml: '',				//if it is required to use a templatetags grip it can be done using some templatetags HTML
