...
$(document).ready((function () {
  // delete object of row from Obj
    ...
    $(document).on("click", "#addpo_button", function () {
  ...
  // balance calculations
    ...
    $(document).on("change", "#id_supplier", function () {
        ...
        $.ajax({
            url: '/porders/porder_balance?id=' + id,
            type: 'GET',
            success: function (data) {
                prePopulate = $.parseJSON(data);
...
//         });
    ...
    $(document).on("change", ".barcode", function () {
        ...
        $.ajax({
            url: '/porders/poproduct?barcode=' + barcode,
            type: 'GET',
            success: function (data) {
