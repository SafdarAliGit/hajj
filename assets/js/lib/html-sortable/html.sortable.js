...
var sortables = [];
/*
 * remove event handlers from products
 * @param [jquery Collection] products
...
var _destroySortable = function(sortable) {
  ...
  // remove event handlers & data from products
...
var sortable = function(selector, options) {
  ...
  return $sortables.each(function() {
    ...
    // Handle drag events on draggable products
    ...
    // Handle dragover and dragenter events on draggable products
