   ...
   // delete object of row from Obj
    ...
    $(document).on("keyup", "#id_received", function () {
        ...
        if (parseInt(r) > parseInt(a)) {
            sweetAlert({
                title: "Oops!",
                text: "Receiving amount can't greater than invoice amount!",
                type: "error"
            });
            $("#id_received").val(a);

            // balance calculations
            net_amount = $('#id_net_amount').val().toFixed(3);
            received = $('#id_received').val();
            ...
            sweetAlert({
                title: "Oops!",
                text: "Received amount can't be 0 less than zero !",
                type: "error"
            });
            $("#id_received").val(0);
...
//         });
    ...
    $(document).on("change", ".barcode", function () {
        ...
        $.ajax({
            url: '/sales/sproduct?barcode=' + barcode,
            type: 'GET',
            success: function (data) {
