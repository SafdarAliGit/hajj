...
function Calculations(rowID) {
    ...
    qty_sold = $("#" + rowID + " .qtyreturned").val();
...
$(document).ready((function () {
    ...
    $(document).on("click", "#addpor_button", function () {
    ...
    $("#id_supplier").chosen({no_results_text: "Oops, nothing found!", width: "100%"});
  ...
  // balance calculations
    ...
    $(document).on("keyup", ".price", function () {
        ...
        qtyreturned = $("#" + trid + " .qtyreturned").val();
    ...
    $(document).on("change", ".product", function () {
        ...
        $.ajax({
            url: '/purchasereturn/prproduct?id=' + id,
            type: 'GET',
            success: function (data) {
                if (Obj.find_id(id) == undefined) {
                    ...
                    //check on qtysold
                    // var q = $("#" + Obj.find_id(id).row + " .qtyreturned").val();
    ...
    $(document).on("change", ".location", function () {
        ...
        $.ajax({
            url: '/purchasereturn/get_prstock',
            data: {
                'id': id,
                'pid':product_id
            },
    ...
    $(document).on("change", "#id_supplier", function () {
        ...
        $.ajax({
            url: '/purchasereturn/pr_balance?id=' + id,
            type: 'GET',
            success: function (data) {
                prePopulate = $.parseJSON(data);
...
//         });
    ...
    $(document).on("change", ".barcode", function () {
        ...
        $.ajax({
            url: '/purchasereturn/prproduct?barcode=' + barcode,
            type: 'GET',
            success: function (data) {
                if (Obj.find_barcode(barcode) == undefined) {
                    ...
                    // check on qtysold
                    // var q = $("#" + Obj.find_barcode(barcode).row + " .qtyreturned").val();
