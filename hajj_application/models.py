...
from package_making.models import Package
...
class HajjApplication(TimeStampModel):
    ...
    group_coordinator_application_no = models.CharField(max_length=20, null=True,
                                                        verbose_name='Group Coordinator\'s Application No')
    hgo_no = models.CharField(max_length=20, null=True, verbose_name='HGO No')
    stay_duration = models.CharField(max_length=10, null=False, verbose_name='Stay Duration', choices=STAY_DURATION,
                                     default=None)
    substituted_against_application_no = models.CharField(max_length=20, null=True,
                                                          verbose_name="Subsitituted Against Application No")
    name_of_applicant_as_per_passport = models.CharField(max_length=50, null=True,
                                                         verbose_name='Name of Applicant as per passport')
    ...
    blood_group = models.CharField(max_length=10, null=False, verbose_name='Blood Group', choices=BLOOD_GROUP,
                                   default=None)
    ...
    are_you_married = models.CharField(max_length=5, null=False, verbose_name='Are You Married', choices=MARRIED,
                                       default=None)
    ...
    performed_hajj_in_last_five_years = models.CharField(max_length=5, null=True,
                                                         verbose_name='Performed Hajj in Last five years',
                                                         choices=PERFORMED_HAJJ_IN_LAST_5_YEARS, default=None)
    want_to_perform_hajj_e_badal = models.CharField(max_length=5, null=False,
                                                    verbose_name='Want to perform Hajj-e-Badal',
                                                    choices=WANT_TO_PERFORM_HAJJ_E_BADAL, default=None)
    want_to_perform_hajj_as_group_worker = models.CharField(max_length=5, null=True,
                                                            verbose_name='Want to perform Hajj as gorup worker',
                                                            choices=WANT_TO_PERFORM_HAJJ_AS_GROUP_WORKER, default=None)
    are_you_mehram_of_a_lady = models.CharField(max_length=5, null=False, verbose_name='Are you mehram of a lady',
                                                choices=ARE_YOUR_MEHRAM, default=None)
    cnic_no_of_lady = models.CharField(max_length=20, null=True,
                                       verbose_name='CNIC No of Lady who have not performed Hajj in last five years')
    ...
    package = models.ForeignKey(Package, on_delete=models.CASCADE, null=True, verbose_name='Package')
...
@receiver(pre_save, sender=HajjApplication)
def set_hajj_application_fields(sender, instance, **kwargs):
    if instance.package:
